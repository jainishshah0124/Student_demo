...
jainish_img = face_recognition.load_image_file("Jainish/jainish.jpg")
jainish_face_encoding = face_recognition.face_encodings(jainish_img)[0]

# Create arrays of known face encodings and their names
known_face_encodings = [
    krish_face_encoding,
    bradley_face_encoding,jainish_face_encoding
]
known_face_names = [
    "Krish",
    "Bradley","Jainish"
