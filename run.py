...
connection_string = "dbname='postgres' user='postgres' host='demodatabase.c5uoa0cyeu2j.us-east-2.rds.amazonaws.com' password='password123' port='5432'"
...
predictor = dlib.shape_predictor(r"Shape_Model/shape_predictor_68_face_landmarks.dat")
...
f = open(r"System_Settings/Face_rec.txt")
